...
class SplashViewModel(
    ...
    init {
        viewModelScope.launch {
            ...
            val authStatesResult = determineAuthStatesUseCase()
            when (authStatesResult) {
                is DomainResult.Success -> {
                    val destination = authFlowNavigationMapper.determineDestination(authStatesResult.data)
                    _uiState.value = UiState(isLoading = false, errorMessage = null)
                ...
                is DomainResult.Failure -> {
                    ...
                    _uiState.value = UiState(isLoading = false, errorMessage = errorMessage)
                }
            }
        }
    }
