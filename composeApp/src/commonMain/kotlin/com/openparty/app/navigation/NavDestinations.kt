//File: composeApp/src/commonMain/kotlin/com/openparty/app/navigation/NavDestinations.kt
...
sealed class NavDestinations(val route: String) {
    ...
    data class AddComment(val discussionId: String, val titleText: String) :
